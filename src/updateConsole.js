...
class updateConsole extends Component {
    ...
    componentDidMount() {
        axios.get(`https://cors-anywhere.herokuapp.com/https://shutdown-2modles-api.herokuapp.com/consoles/${this.props.match.params.id}`
        )
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.patch(`https://cors-anywhere.herokuapp.com/https://shutdown-2modles-api.herokuapp.com/consoles/${this.props.match.params.id}/edit`, obj)
...
//           about:this.state.about
//         };
//         axios.post(`https://cors-anywhere.herokuapp.com/https://shutdown-2modles-api.herokuapp.com/consoles/${this.props.match.params.id}/edit`, obj)
//             .then(res => console.log(res.data));
//         this.props.history.push('/');
//     }
